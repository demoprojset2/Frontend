  ...
  render() {
    ...
    return (
      <div>
        <ToastContainer />
        <Navbar />
        <div className="d-flex justify-content-around my-4 mt-4 mb-2" style={{ width: "100%" }}>

          <div><h1 className="center">Patient Details</h1></div>
        ...
        <form className="row g-3 needs-validation m-0 p-0" onSubmit={this.handleSubmit}  >
          <div className="d-flex mx-2 nn justify-content-center" style={{ width: "95%" }}  >
            ...
            <div className="container shadow-lg ro1  py-3" style={{ width: "30rem", backgroundColor: "#ACE1AF" }}>
            ...
            <div className="container shadow-lg ro2 py-3 btom" style={{ width: "30rem", backgroundColor: "#ACE1AF" }}>
              <div className="row g-3" >
                <div className="col-md-6">
                  <label style={{ fontSize: "20px", fontWeight: "normal", color: "#040914" }} htmlFor="validationCustom01" className="form-label">
                    Weight (kg)
          ...
          <div className="d-flex justify-content-evenly foot">
            <div>
              <button className="btn mb-2" style={{ fontWeight: "bold",backgroundColor:"#bd97f0", color:"black" }} type="submit">
                Add Patient
              </button>
            </div>
            {this.state.show ?
