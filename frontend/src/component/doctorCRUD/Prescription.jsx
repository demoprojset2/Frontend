  ...
  return (
    ...
    <div className="card mb-2">
      <div class="card-header d-flex flex-row justify-content-between" id="heading">
        ...
        <button className="btn btn-link text-dark ml-0" onClick={(e) => { if (window.confirm('Are you sure you wish to delete this item?')) handleDelete(e, all.id) } }><i class="fas fa-trash"></i></button>
        </div>
      </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-4">
                ...
                >
                  ...
                  <option selected={dose_timing==="Per Quarter Hour"} value="Per Quater Hour">Per Quarter Hour</option>
                </select>
